...
public class AINameGenerator {
    ...
    public static String generateName() {
        ...
        return switch (style) {
            ...
            case 1 -> getRandom(PREFIXES) + "_" + getRandom(NUMBERS);
            case 2 -> getRandom(SUFFIXES) + "_" + (random.nextInt(9000) + 1000);
            case 3 -> "xX_" + getRandom(PREFIXES) + "_Xx";
            case 4 -> getRandom(PREFIXES) + getRandom(SUFFIXES) + random.nextInt(10);
            default -> getRandom(SUFFIXES) + random.nextInt(100);
        };
    }
